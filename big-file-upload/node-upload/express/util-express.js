...
module.exports = class FileUpload {
    ...
    async handleVerifyUpload(req, res) {
        ...
        const filePath = path.resolve(PATH_EXPRESS_UPLOADDIST, filename);
    ...
    async handleFormData(req, res) {
        ...
        multipart.parse(req, async (err, fields, files) => {
            ...
            */
            ...
            const chunkDist = path.resolve(PATH_EXPRESS_UPLOADDIST, filename);
    ...
    async handleMerge(req, res) {
        ...
        const filePath = path.resolve(PATH_EXPRESS_UPLOADDIST, `MERGE_${filename}`);
    ...
    async deleteFiles(req, res) {
        await fse.remove(path.resolve(PATH_EXPRESS_UPLOADDIST));
        res.end(
            JSON.stringify({
                status: 'ok',
